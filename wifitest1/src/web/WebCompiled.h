...
void AddServerPages(AsyncWebServer &server) {
  server.onNotFound([](AsyncWebServerRequest *request) {
    request->send(
        404, "text/html",
        "<html><head><title>you done messed up b-lak-ae</title><style>body "
        "{background-color: #ffffff;color: #2200aa;font-family: \"Courier "
        "New\", Courier, monospace;font-size: 1em;text-align: "
        "center;}button{background-color: #ffffff;color: #2200aa;font-family: "
        "\"Courier New\", Courier, monospace;font-size: 1em;text-align: "
        "center;border: 2px solid #2200aa;border-radius: "
        "5px;}</style></head><body><h1>404...</h1><p> No content here</p><p> "
        "Go back <a href = \"/\">home. </a></p><a href=\"/\"><button>Click "
        "me</button></a></html>");
  });
  ...
  server.on("/page", HTTP_GET, [](AsyncWebServerRequest *request) {
    request->send(
        ...
        "content=\"width=device-width\"><title>Wifi Test</title><style>body "
        "{background-color: #000000;color: #00ff00;font-family: \"Courier "
        "New\", Courier, monospace;font-size: 1em;text-align: "
        "center;}</style></head><body><h1>UA Robotics</h1><p>Those "
        "semi-conductors never stood a chance...</p><hr color=\"#00ff00\"><p> "
        "<a href=\"/hello\"> Goto hard coded page.</a></p><p><a "
        "href=\"http://kentstatesucks.gozips.com\">Try a new domain "
        "on</a></p></body></html>");
  });
}
